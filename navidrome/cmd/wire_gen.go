...
func CreateSubsonicAPIRouter(ctx context.Context) *subsonic.Router {
	...
	alistClient := alist.New()
	router := subsonic.New(dataStore, artworkArtwork, mediaStreamer, archiver, players, provider, modelScanner, broker, playlistsPlaylists, playTracker, share, playbackServer, metricsMetrics, lyricsLyrics, transcodeDecider, alistClient)
	return router
}
...
func CreatePublicRouter() *public.Router {
	...
	archiver := core.NewArchiver(mediaStreamer, dataStore, share)
	alistClient := alist.New()
	router := public.New(dataStore, artworkArtwork, mediaStreamer, share, archiver, alistClient)
	return router
}
