...
import (
	...
	"github.com/navidrome/navidrome/core/alist"
...
func New(ds model.DataStore, artwork artwork.Artwork, streamer stream.MediaStreamer, share core.Share, archiver core.Archiver, alist *alist.Client) *Router {
	p := &Router{ds: ds, artwork: artwork, streamer: streamer, share: share, archiver: archiver, alist: alist}
